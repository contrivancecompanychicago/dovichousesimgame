 ...
 */
public class DOVICHouseBasementScene extends Scene
{
    ...
    public DOVICHouseBasementScene(Game game, String entrance)
	{
        super(game, "images/castlebasement.png", "DOVICHouseBasementScene");
	...
	public void handleSwitchScene(Rectangle exit)
	{
        if (exit == warpExit)
        {
			game.setScene(new ArmosScene(game, "DOVICHouseBasementScene"));
        }
        if (exit == exitUp)
		{
            game.setScene(new CastleScene(game, "DOVICHouseBasementScene"));
		}
	}
	...
	{
        if(entrance.equals("BasementScene"))
		{
			moveScene(482, 1);
